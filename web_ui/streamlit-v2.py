...
if not isinstance(st.session_state.visualization_data, dict):
    ...
    if df_to_display is None or df_to_display.empty:
        ...
        if active_chart_type == 'table':
            ...
            if df_to_display.index.name or not isinstance(df_to_display.index, pd.RangeIndex):
                st.dataframe(df_to_display.reset_index(), use_container_width=True, hide_index=True)
            else:
